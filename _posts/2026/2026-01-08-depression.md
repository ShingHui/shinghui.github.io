...
image:
  path: /assets/img/portfolio/statistic-project.webp
...
<style>
  ...
  .story-flow-bar span.step-tag {
    padding: 3px 10px;
    font-weight: bold;
    white-space: nowrap;
  }
  .story-flow-bar span.arrow {
    font-size: 1rem;
    opacity: 0.7;
  }
...
<div class="comic-wrapper">
  ...
  <div class="story-flow-bar">
    <span class="step-tag" style="background:#e53935;">① Stress → Depression</span>
    <span class="arrow">▶</span>
    <span class="step-tag" style="background:#00897b;">② Resilience Buffer</span>
    <span class="arrow">▶</span>
    <span class="step-tag" style="background:#7cb342;">③ Real Enemy</span>
    <span class="arrow">▶</span>
    <span class="step-tag" style="background:#ab47bc;">④ Plot Twist</span>
    <span class="arrow">▶</span>
    <span class="step-tag" style="background:#546e7a;">⑤ Conclusion</span>
  </div>

  <!-- Row 1: The Conflict + The Buffer -->
  <div class="comic-grid">

    <!-- Panel ①: The Pressure Cooker -->
    <div class="comic-panel">
      <span class="comic-label" style="background: #e53935;">The Conflict</span>
      <span class="panel-step">①</span>
  ...
  <div class="comic-grid">
    ...
    <div class="comic-panel" style="background: #e0f2f1;">
      ...
      <span class="panel-step" style="background:#00897b;">④</span>
  ...
  <!-- Row 3: Verdict + Plot Twist -->
  <div class="comic-grid">

    <!-- Panel ⑤: Who is the Real Enemy -->
    <div class="comic-panel panel-stats">
      <span class="comic-label" style="background: #7cb342;">The Verdict</span>
      <span class="panel-step" style="background:#7cb342;">⑤</span>
    ...
    <div class="comic-panel">
      ...
      <span class="panel-step" style="background:#ab47bc;">⑥</span>
  ...
  <!-- ⑦ Epilogue -->
  <div class="comic-grid">
    <div class="comic-panel panel-full" style="background: #2d3748; color: #fff; margin-bottom: 0; position: relative;">
      <span class="panel-step" style="background:#546e7a; top: -16px;">⑦</span>
