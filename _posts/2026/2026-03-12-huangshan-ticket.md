...
.cp-post h4 a[href^="#"],
.cp-post .anchor,
.cp-post .header-anchor,
.cp-post .anchor-heading { display: none !important; }
...
.cp-post .hero-title {
  ...
  font-size: clamp(2.4rem, 8vw, 5.5rem); font-weight: 900; color: #fff;
  line-height: 1.05; letter-spacing: -0.02em; margin: 0;
}
.cp-post .hero-title em {
  display: block; font-style: italic;
  color: var(--cloud); font-size: 0.75em;
}
...
/* ── LAYOUT ── */
.cp-post .section       { padding: 5rem 5vw; }
...
.cp-post h2.light    { color: #f5f0e8 !important; }
.cp-post h2.cp-h2 em { font-style: italic; color: var(--pine-light); }
.cp-post h2.light em { color: var(--cloud) !important; }

.cp-post .cp-p { color: var(--muted); line-height: 1.9; margin-bottom: 1.3rem; font-size: 18px; }

/* ── DARK MODE OVERRIDES ── */
.cp-post .section-stone                  { background: #2a2620 !important; }
.cp-post .section-stone h2.light         { color: #f5f0e8 !important; }
.cp-post .section-stone h2.light em      { color: #c8d4c0 !important; }
.cp-post .section-stone .label.light     { color: #c8d4c0 !important; }
...
.cp-post .paid-line {
  ...
  font-family: 'Space Mono', monospace; font-size: 0.8rem; color: rgba(200,212,192,0.7);
}
...
.cp-post .paid-note { margin-top: 1.2rem; font-size: 18px; color: rgba(200,212,192,0.55); line-height: 1.7; }
...
.cp-post .step-body p      { font-size: 18px; color: var(--muted); line-height: 1.7; }
.cp-post .step-body strong { color: var(--ink); }

/* ── CALLOUTS ── */
.cp-post .story-callout {
  border-left: 4px solid var(--gold);
  background: rgba(184,134,11,0.04);
  padding: 2rem 2.5rem; margin: 3rem 0;
}
.cp-post .story-eyebrow {
  font-family: 'Space Mono', monospace; font-size: 0.62rem;
  letter-spacing: 0.18em; text-transform: uppercase;
  color: var(--gold); margin-bottom: 1rem; display: block;
}
.cp-post .story-body     { font-size: 18px; color: var(--ink); line-height: 1.85; }
.cp-post .story-body em  { font-style: italic; color: var(--stone); }

.cp-post .warning-callout {
  border-left: 4px solid var(--red);
  background: rgba(139,46,46,0.04);
  padding: 2rem 2.5rem; margin: 3rem 0;
}
.cp-post .warning-eyebrow {
  font-family: 'Space Mono', monospace; font-size: 0.62rem;
  letter-spacing: 0.18em; text-transform: uppercase;
...
.cp-post .tip-text   { font-size: 18px; color: var(--muted); line-height: 1.65; }
...
/* ── PHOTO STRIP ── */
.cp-post .gallery-section { padding: 5rem 0; background: var(--paper); }
...
.cp-post .photo-strip img {
  ...
  border: 1px solid var(--border); transition: opacity 0.2s ease;
}
.cp-post .photo-strip img:hover { opacity: 0.88; }

/* ── KEYFRAMES (ticker only — no content-hiding animations) ── */
...
<section class="section">
  <div class="inner">
    ...
    <h2 class="cp-h2">Do You Need a<br/><em>Chinese Phone Number?</em></h2>
    ...
    <p class="cp-p">Screenshots below are from my actual purchase in September 2025 — via WeChat Mini Program, covering entrance options, ticket confirmations, and what I paid as a foreign visitor.</p>
  </div>
</section>
...
<section class="section section-fog">
  <div class="inner">
    <span class="label gold">Official Prices · 2025</span>
    <h2 class="cp-h2">What It <em>Costs</em></h2>
    ...
    <div class="paid-card">
      ...
      <div class="paid-line"><span>Yungu Shuttle Bus (single trip)</span><strong>19 RMB</strong></div>
      <div class="paid-line"><span>Ciguangge Shuttle Bus (single trip down)</span><strong>19 RMB</strong></div>
...
<section class="section section-paper">
  <div class="inner">
    <span class="label">WeChat Mini Program</span>
    <h2 class="cp-h2">Buying via <em>WeChat</em></h2>
...
<section class="gallery-section">
  <div class="inner">
    <span class="label">Screenshots · In Action</span>
    <h2 class="cp-h2">What It <em>Looks Like</em></h2>
    <p class="cp-p">My actual screenshots — swipe to see the full flow.</p>
  </div>
...
<section class="section section-stone">
  <div class="inner">
    <span class="label light">Alternative Options</span>
    <h2 class="cp-h2 light">Book Online <em>or On-Site</em></h2>
    <p class="cp-p" style="color: rgba(200,212,192,0.7);">If the WeChat Mini Program doesn't work for you, two reliable alternatives:</p>
    <div class="tips-grid">
      <div class="tip-card" style="background: rgba(255,255,255,0.04); border-color: rgba(200,212,192,0.15);">
