...
<section class="section section-paper">
  <div class="inner">
    ...
    <div class="paid-card reveal">
      ...
      <p class="cp-p" style="color:rgba(200,212,192,0.55); margin-top:1rem;">💡 <a href="/posts/huangshan-ticket/" style="color:var(--cloud);">Step-by-step ticket buying guide with screenshots →</a></p>
    </div>
  </div>
</section>
